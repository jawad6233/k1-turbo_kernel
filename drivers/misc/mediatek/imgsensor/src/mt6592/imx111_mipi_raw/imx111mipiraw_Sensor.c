...
static void IMX111MIPI_Sensor_Init(void)
{
	...
	IMX111MIPI_write_cmos_sensor(0x0101, 0x03);//
...
{	
		...
		/*
		IMX111MIPI_write_cmos_sensor(0x0344,0x00);	//x_addr_start[15:8]
		IMX111MIPI_write_cmos_sensor(0x0345,0x08+1);  //x_addr_start[7:0]
		IMX111MIPI_write_cmos_sensor(0x0346,0x00);	//y_addr_start[15:8]
		IMX111MIPI_write_cmos_sensor(0x0347,0x30+1);	//y_addr_start[7:0]
		IMX111MIPI_write_cmos_sensor(0x0348,0x0C);	//x_addr_end[15:8]
		IMX111MIPI_write_cmos_sensor(0x0349,0xD7+1);	//x_addr_end[7:0]
		IMX111MIPI_write_cmos_sensor(0x034A,0x09); 	//y_addr_end[15:8]
		IMX111MIPI_write_cmos_sensor(0x034B,0xCF+1);	//y_addr_end[7:0]
		*/
		...
		/*
		IMX111MIPI_write_cmos_sensor(0x0344,0x00);
		IMX111MIPI_write_cmos_sensor(0x0345,0x00);
		IMX111MIPI_write_cmos_sensor(0x0346,0x00);
		IMX111MIPI_write_cmos_sensor(0x0347,0x00);
		IMX111MIPI_write_cmos_sensor(0x0348,0x00);
		IMX111MIPI_write_cmos_sensor(0x0349,0x00);
		IMX111MIPI_write_cmos_sensor(0x034A,0x00);
		IMX111MIPI_write_cmos_sensor(0x034B,0x00);
		*/
...
void PreviewSetting(void)
	{	
		...
		IMX111MIPI_write_cmos_sensor(0x0344,0x00);	//x_addr_start[15:8]
		IMX111MIPI_write_cmos_sensor(0x0345,0x08);  //x_addr_start[7:0]
		IMX111MIPI_write_cmos_sensor(0x0346,0x00);	//y_addr_start[15:8]
		IMX111MIPI_write_cmos_sensor(0x0347,0x30);	//y_addr_start[7:0]
		IMX111MIPI_write_cmos_sensor(0x0348,0x0C);	//x_addr_end[15:8]
		IMX111MIPI_write_cmos_sensor(0x0349,0xD7);	//x_addr_end[7:0]
		IMX111MIPI_write_cmos_sensor(0x034A,0x09); 	//y_addr_end[15:8]
		IMX111MIPI_write_cmos_sensor(0x034B,0xCF);	//y_addr_end[7:0]
		/*
		IMX111MIPI_write_cmos_sensor(0x0344,0x00);
		IMX111MIPI_write_cmos_sensor(0x0345,0x00);
		IMX111MIPI_write_cmos_sensor(0x0346,0x00);
...
UINT32 IMX111MIPIOpen(void)
{
   int  retry = 0; 
    ...
    do {
	   ...
	   spin_unlock(&imx111_drv_lock);
	   	SENSORDB("Read imx111 Sensor ID = 0x%04x\n", IMX111MIPI_sensor_id); //xujun0629
...
UINT32 IMX111MIPIGetSensorID(UINT32 *sensorID) 
{
   int  retry = 3; 
    ...
    do {		
      ...
      {
            printk("imx111 Read Sensor ID  = 0x%04x\n",*sensorID);
            break;
      }
        printk("imx111 Read Sensor ID Fail = 0x%04x\n", *sensorID); 
        retry--; 
...
UINT32 IMX111_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
		SENSORDB("xujun IMX111_MIPI_RAW_SensorInit\n"); 
    if (pfFunc!=NULL)
